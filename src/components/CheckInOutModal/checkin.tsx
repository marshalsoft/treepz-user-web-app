...
export const CheckInModal = (props:UserProps & PageProps)=>{
  ...
  const onScanSuccess = ()=>{
    setLoading(true);
    PostRequest("employee/attendence/check-in",{
      location:""
    },true).then((res)=>{
     setLoading(false);
     if(res.success)
  ...
  const onScanFailed= ()=>{
    ...
    if(done)
    {
        return <div className="modal-view">
            ...
            <div className="fw-bold text-center">Welcome on board, {props.firstname}</div>
            <div className="text-center sub mb-3">You have been successfully checked in.</div>
            <div className="text-center gray-card">
                <div className="row">
                <div className="col-6">
                <div className="fw-normal">Check-in Details:</div>
   ...
   <div
    ...
    >
    <span>Scan the QR presented by your driver to check into the bus.</span>
    </div>
    </div>
}